...
pygame.mixer.init() #Initializing Queue for Pygame Mixer for Audio 
    ...
    def Update(self,game):
        ...
        if self.IsDead:
            ...
            for snake in alivelist:
                if head in snake.body:
                    if head == snake.body[0]:#If Snake Collides with Body
                        ...
                        pygame.mixer.music.play(loops=0) #Play Death Sound
                        snake.IsDead=True
                    self.IsDead=True
                    return
            ...
            if head in game.obstacles: #If the Snake Hit an Obstacle
                ...
                pygame.mixer.music.play(loops=0) #Play Crunch Sound
                self.body.append((self.body[0])) #Make Body Longer by Appending another Pixel in the Body of the Snake
...
class HumanSnake(Snake): #Snake Controls 
    def __init__(self,body=[(0,0)] , direction=(1,0),upkey=K_UP,downkey=K_DOWN,rightkey=K_RIGHT,leftkey=K_LEFT,color=(125,195,131)): #Color ng Isnek
...
class SnakeGame:
    ...
    def __init__(self):
        ...
        self.obstacles=[]
        self.obscolor=("#333333")
        self.foodcolor=("#FF597B")
        self.foodpos=(0,0)
        self.playercount=0
